...
<div class="row justify-content-center">
  <div class="col-12">
      ...
      <div class="card-body table-responsive p-0" style="height: 450px;">
        <table class="table table-head-fixed text-nowrap">
          ...
          <tbody>
            ...
            <?php
              $stmt = $pdo->query("SELECT karyawanid, nilai FROM `penilaian` WHERE `kategori` = 'kehadiran'");
    ...
    <div class="row">
      ...
      <div class="col-4">
        <a href="index.php" class="btn btn-primary btn-block">Batal</a>
      </div>
      <div class="col-4">
      <input type="hidden" name="kategoriinput" value="kehadiran"></input>
