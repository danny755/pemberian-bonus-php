...
<div class="row justify-content-center">
  <div class="col-12">
      ...
      <div class="card-body table-responsive p-0" style="height: 450px;">
        <table class="table table-head-fixed text-nowrap">
          ...
          <tbody>
            ...
            <?php
              $stmt = $pdo->query("SELECT karyawanid, nilai FROM `penilaian` WHERE `kategori` = 'kinerja'");
    ...
    <div class="row">
      ...
      <div class="col-4">
        <a href="proses/proseslogout.php" class="btn btn-primary btn-block">Logout</a>
      </div>
      <div class="col-4">
        <input type="hidden" name="kategoriinput" value="kinerja"></input>
