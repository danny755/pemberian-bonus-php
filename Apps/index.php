              ...
              <div class="col-sm-6 text-center">
                ...
                if (!empty($_GET['halaman'])) {
                  if ($_GET['halaman'] == 'kinerja') {
                    ...
                    $judul = '<b>Karyawan</b>';
                  } elseif ($_GET['halaman'] == 'create_karyawan') {
                    $judul = '<b>Tambah Karyawan</b>';
                  } elseif ($_GET['halaman'] == 'store_karyawan') {
                    $judul = '<b>Store Karyawan</b>';
                  } elseif ($_GET['halaman'] == 'edit_karyawan') {
                    $judul = '<b>Edit Karyawan</b>';
                  } elseif ($_GET['halaman'] == 'update_karyawan') {
                    $judul = '<b>Update Karyawan</b>';
                  } elseif ($_GET['halaman'] == 'delete_karyawan') {
                    $judul = '<b>Delete Karyawan</b>';
                  }
                } else {
                  ...
                  <div class="card-body">
                    ...
                    if (!empty($_GET['halaman'])) {
                      if ($_GET['halaman'] == 'kinerja') {
                        ...
                        include('pages/karyawan/store.php');
                      } elseif ($_GET['halaman'] == 'edit_karyawan') {
                        include('pages/karyawan/edit.php');
                      } elseif ($_GET['halaman'] == 'update_karyawan') {
                        include('pages/karyawan/update.php');
                      } elseif ($_GET['halaman'] == 'delete_karyawan') {
